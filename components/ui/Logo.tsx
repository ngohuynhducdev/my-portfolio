...
export default function Logo() {
  return (
    <span className="inline-flex items-center gap-1.5 leading-none">
      <span className="flex h-8 w-8 items-center justify-center rounded-xl border-2 border-primary bg-primary sm:h-6 sm:w-6 sm:rounded-lg">
        <span className="h-3.5 w-0.5 rotate-12 rounded-full bg-white sm:h-3" />
      </span>
